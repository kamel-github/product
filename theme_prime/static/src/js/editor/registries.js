...
registry.category('theme_prime_snippet_registry')
    ...
    .add('s_tp_mega_menu_category_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { cardRegistry: 'theme_prime_mega_menu_cards', maxValue: 10, minValue:2, subComponents: ['style', 'productListing','limit'] } }, defaultValue: { noSwicher: true } })
    .add('s_category_tabs_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { cardRegistry: 'theme_prime_mega_menu_tabs_styles', maxValue: 12, minValue:2, subComponents: ['style', 'limit', 'categoryTabsConfig'] } }, defaultValue: { noSwicher: true } });
