...
class HrRulesAttendance(models.Model):
    _inherit = "hr.work.entry"
    _description = "Rules Work Entry"

    state = fields.Selection(selection_add=[('validated_attendances', 'Validated Attendances'), ('validated',)])
